\documentclass[
  ...
  group,
  seat=title,
  autoseries, % skip menu, directly create in series mode
  ...
  \begin{questions}
      ...
      %
      % Varianten für Gruppen: Der Text in im Environment "onlygroup" wird nur
      % aufgenommen, wenn die übergebene \studentgroup im Argument der Umgebung
      % (kommasepariert) auftaucht
      \begin{onlygroup}{A}
      ...
      \begin{onlygroup}{B}
          ...
          \question[23] \deen{Wer gibt die Antwort auf die Frage nach dem Universum,
            dem Leben und den ganzen Rest?}{Who answers the question for
            life, universe, and everything?}
      ...
      \begin{onlygroup}{A,B}
          ...
          \question[23] \deen{Wer hat sich diesen Unsinn ausgedacht?}{Who
            maked up this nonsense?}
          
          \fillin[Douglas N. Adams]
      \end{onlygroup}

      \begin{onlygroup}{X} % Ist geheim, da keine Gruppe X in der Excel-Datei existiert 
          \question[1] \deen{What is the question}
      \end{onlygroup}
